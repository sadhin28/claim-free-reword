...
export default function Navbar() {
  ...
  return (
    <nav className="border-b-2 shadow-md bg-gradient-to-r from-blue-500 via-indigo-600 to-purple-700  sticky  top-0 z-30 backdrop-blur-2xl  text-white px-6 py-5">
