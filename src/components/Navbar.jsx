...
export default function Navbar() {
  ...
  return (
    <nav className="border-b-2 border-blue-600/20 shadow-md bg-gradient-to-r from-indigo-400 via-blue-400 to-purple-400  sticky  top-0 z-30 backdrop-blur-2xl  text-white px-6 py-5">
